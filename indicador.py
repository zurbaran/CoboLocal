...
def puntocurvaexponencial(ltdateini, ltpriceini, ltdatefin, ltpricefin, timming, **config):
    ...
    83.182
    >>> puntocurvaexponencial('2008-01-25', 48.260, '2008-04-18', 76.958, 'm', fechahoy='2008-04-25')
    76.958
    >>> puntocurvaexponencial('2008-01-25', 48.260, '2008-04-18', 76.958, 'w', fechahoy='2008-06-27')
    113.538
    >>> puntocurvaexponencial('2012-05-01', 24.90, '2013-04-01', 43.61, 'm', fechahoy='2013-05-01')
    45.886
    >>> puntocurvaexponencial('2012-05-01', 24.90, '2013-04-01', 43.61, 'm', fechahoy='2013-05-15')
    45.886
    >>> puntocurvaexponencial('2012-05-01', 24.90, '2013-04-01', 43.61, 'm', fechahoy='2013-06-01')
    48.282
    >>> puntocurvaexponencial('2011-06-01', 4.5, '2013-02-01', 15.2, 'w', fechahoy='2013-06-10')
    19.537
    >>> puntocurvaexponencial('2011-06-01', 15.2, '2013-02-01', 4.5, 'm', fechahoy='2013-06-10')
    3.531
    >>> puntocurvaexponencial('2011-06-01', 15.2, '2013-02-01', 4.5, 'w', fechahoy='2013-06-10')
    3.501
